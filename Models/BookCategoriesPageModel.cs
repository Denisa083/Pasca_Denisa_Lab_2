...
namespace Pasca_Denisa_Lab_2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Pasca_Denisa_Lab_2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Pasca_Denisa_Lab_2Context context,
