...
namespace Pasca_Denisa_Lab_2.Migrations
{
    ...
    [Migration("20221115115451_Member")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pasca_Denisa_Lab_2.Models.Book", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pasca_Denisa_Lab_2.Models.BookCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pasca_Denisa_Lab_2.Models.Book", b =>
                {
                    b.HasOne("Pasca_Denisa_Lab_2.Models.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorID");

                    b.HasOne("Pasca_Denisa_Lab_2.Models.Publisher", "Publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Pasca_Denisa_Lab_2.Models.BookCategory", b =>
                {
                    ...
                    b.HasOne("Pasca_Denisa_Lab_2.Models.Category", "Category")
                        .WithMany("BookCategories")
            ...
            modelBuilder.Entity("Pasca_Denisa_Lab_2.Models.Borrowing", b =>
                {
                    ...
                    b.HasOne("Pasca_Denisa_Lab_2.Models.Member", null)
                        .WithMany("Borrowings")
